...
namespace EventApi.Controllers
{
    ...
    public class EventApiController : ControllerBase
    {
        ...
        // GET: api/EventApi
        [HttpGet]
        public async Task<ActionResult<IEnumerable<EventApi.Models.EventApi>>> GetEventApis()
        {
        ...
        // GET: api/EventApi/5
        [HttpGet("{id}")]
        public async Task<ActionResult<EventApi.Models.EventApi>> GetEventApi(int id)
        {
        ...
        // POST: api/EventApi
        [HttpPost]
        public async Task<ActionResult<EventApi.Models.EventApi>> PostEventApi(EventApi.Models.EventApi EventApi)
        {
        ...
        // PUT: api/EventApi/5
        [HttpPut("{id}")]
        public async Task<IActionResult> PutEventApi(int id, EventApi.Models.EventApi EventApi)
        {
            if (id != EventApi.Id)
            {
                return BadRequest();
